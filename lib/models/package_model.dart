class PackageModel {
  ...
  factory PackageModel.fromJson(Map<String, dynamic> json) => PackageModel(
        ...
        packageWeight: (json['package_weight'] ?? json['packageWeight'] as num?)?.toDouble(),
        ...
        estimatedCost: (json['estimated_cost'] ?? json['total_amount'] ?? json['totalAmount'] as num?)?.toDouble(),
